#ifndef PAGEERRORHELPRESPONSE_H
#define PAGEERRORHELPRESPONSE_H

#include "page.h"
#include <QPoint>

class PageErrorHelpResponse : public Page
{
    Q_OBJECT

public:
    PageErrorHelpResponse(QWidget *parent);
